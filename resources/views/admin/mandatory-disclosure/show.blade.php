<x-app-layout pageTitle="{{ $disclosure->name }}" :breadcrumbs="[
    ['label' => 'Mandatory Disclosures', 'url' => route('admin.mandatory-disclosure.index')],
    ['label' => $disclosure->name, 'url' => null],
]">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <h4 class="header-title mb-0">{{ $disclosure->name }}</h4>
                        <div>
                            <a href="{{ route('admin.mandatory-disclosure.edit', $disclosure) }}"
                                class="btn btn-sm btn-primary">
                                <i class="ri-edit-line me-1"></i> Edit
                            </a>
                            <a href="{{ route('admin.mandatory-disclosure.index') }}"
