<x-app-layout pageTitle="Director" :breadcrumbs="[['label' => 'Authorities', 'url' => null], ['label' => 'Director', 'url' => null]]">

    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title mb-0">Director</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.authority.director.update') }}" method="post"
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i data-lucide="save" class="me-1"></i> Update Director
                            </button>
                        </div>
                    </form>
                </div>
