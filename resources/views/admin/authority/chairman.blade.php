<x-app-layout pageTitle="Chairman" :breadcrumbs="[['label' => 'Authorities', 'url' => null], ['label' => 'Chairman', 'url' => null]]">

    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title mb-0">Chairman</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.authority.chairman.update') }}" method="post"
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i data-lucide="save" class="me-1"></i> Update Chairman
                            </button>
                        </div>
                    </form>
                </div>
