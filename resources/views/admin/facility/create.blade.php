<x-app-layout pageTitle="Create Facility" :breadcrumbs="[['label' => 'Facilities', 'url' => route('admin.facility.index')], ['label' => 'Create', 'url' => null]]">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="header-title mb-0">Create New Facility</h4>
                    ...
                    <form action="{{ route('admin.facility.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('sort_description') is-invalid @enderror" id="sort_description"
                                    name="sort_description" rows="2" maxlength="500" placeholder="Brief one-liner shown on cards and listings">{{ old('sort_description') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control font-monospace @error('description') is-invalid @enderror" id="description"
                                    ...
                                    placeholder="Detailed description. HTML allowed: &lt;b&gt;bold&lt;/b&gt;, &lt;br&gt;, &lt;ul&gt;&lt;li&gt;bullets&lt;/li&gt;&lt;/ul&gt;, &lt;p&gt;paragraphs&lt;/p&gt;">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            <button type="submit" class="btn btn-primary px-4">
                                <i data-lucide="save" class="me-1"></i> Create Facility
                            </button>
                ...
                <div class="card-body">
                    ...
                    <div class="dropzone-thumb mb-2" id="thumbDropzone">
                        ...
                        <div id="thumbDropzoneContent">
                            ...
                            <p class="mb-1 small fw-medium">Click or drag to upload</p>
                            <span class="badge bg-light text-dark border small">JPEG, PNG, WEBP &bull; 2MB &bull;
                                600×400</span>
                        </div>
                    </div>
                    @error('thumbnail')
                    ...
                    @enderror
                    <div class="thumb-preview-box" id="thumbnailPreview" style="display:none;">
                        <img id="thumbnailPreviewImg" src="#" alt="Preview">
                    </div>
                    <div id="thumbnailNoPreview"
                        class="thumb-preview-box d-flex align-items-center justify-content-center"
                        style="height:100px; background:#f5f6f8;">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="highlightsContainer">
                        @php $oldHighlights = old('highlights', ['']); @endphp
    ...
    @push('pageScripts')
        <script>
            (function() {
                ...
                const noPreview = document.getElementById('thumbnailNoPreview');
