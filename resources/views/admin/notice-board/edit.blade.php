<x-app-layout>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.notice-board.update', $notice) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4 class="mb-3">Edit Notice Board</h4>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="4" placeholder="Enter description (optional)">{{ old('description', $notice->description) }}</textarea>
                                    @error('description')
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Accepted: PDF, DOC, DOCX. Max: 5MB. Leave empty
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input @error('is_publish') is-invalid @enderror"
                                            ...
                                            value="1"
                                            {{ old('is_publish', $notice->is_publish) ? 'checked' : '' }}>
