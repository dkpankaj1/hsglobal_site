                ...
                <div class="col col-md-4" style="margin-bottom:26px;">
                    <div
                        ...
                        <i class="fa {{ $data['icon'] }}"
                            style="font-size:70px; color:var(--theme-main); opacity:0.22; margin-bottom:10px;"></i>
            ...
            <div style="margin-top:8px;">
                ...
                <div class="row" style="display:flex; flex-wrap:wrap;">
                    <div class="col col-md-6" style="margin-bottom:16px;">
                        <div
                            style="height:260px; border:2px dashed #c9d8f6; border-radius:8px; background:#f7faff; display:flex; align-items:center; justify-content:center; text-align:center; padding:16px;">
                            <div>
                                <i class="fa fa-image"
                                    style="font-size:34px; color:var(--theme-main); opacity:0.55;"></i>
                                <p style="margin:10px 0 3px; font-size:14px; color:#4d5f87; font-weight:600;">Image
                                    Placeholder 01</p>
                        ...
                        <div class="row" style="display:flex; flex-wrap:wrap;">
                            @for ($i = 2; $i <= 5; $i++)
                                <div class="col col-md-6 col-sm-6" style="margin-bottom:16px;">
                                    <div
                                        style="height:122px; border:2px dashed #c9d8f6; border-radius:8px; background:#f7faff; display:flex; align-items:center; justify-content:center; text-align:center; padding:10px;">
                                        <div>
                                            <i class="fa fa-image"
                                                style="font-size:24px; color:var(--theme-main); opacity:0.55;"></i>
                                            <p
                                                style="margin:6px 0 1px; font-size:13px; color:#4d5f87; font-weight:600;">
                                                Placeholder {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</p>
