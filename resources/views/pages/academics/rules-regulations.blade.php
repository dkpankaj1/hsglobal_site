<x-web-layout>
    ...
    <section style="padding:50px 0;">
        <div class="container">
                ...
                @foreach ($sections as $key => $meta)
                    <div class="col col-md-4 col-sm-6" style="margin-bottom:30px; display:flex; flex-direction:column;">
                        <div
                            ...
                            {{-- Coloured header --}}
                            <div
                                style="background:{{ $meta['accent'] }}; padding:20px 24px;
            ...
            {{-- ── Bottom notice strip ── --}}
            <div
                style="margin-top:14px; background:#fffbea; border:1px solid #ffe082;
                        border-radius:8px; padding:18px 24px; display:flex;
                        align-items:flex-start; gap:14px;">
                <i class="fa fa-exclamation-triangle"
                    style="color:#f9a825; font-size:22px; margin-top:2px; flex-shrink:0;"></i>
                <p style="margin:0; font-size:14px; color:#555; line-height:1.75;">
                    <strong>Note:</strong> Repeated violation of any of the above rules may result in disciplinary
                    action,
