    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="font-size:15px; color:#555; max-width:780px; line-height:1.85; margin-bottom:34px;">
                This class-wise list helps students and parents quickly identify the required books for the academic session.
            ...
            <div class="table-responsive" style="border-radius:8px; overflow:hidden; box-shadow:0 3px 16px rgba(0,0,0,0.08);">
                <table class="table" style="margin:0; background:#fff;">
                    ...
                    <tbody>
                        ...
                        <tr style="background:{{ $index % 2 === 0 ? '#ffffff' : '#f8fafd' }}; border-bottom:1px solid #edf1f6;">
                            <td style="padding:14px 16px; border:none; color:#888; font-size:13px; vertical-align:top;">
                                {{ str_pad($index + 1, 2, '0', STR_PAD_LEFT) }}
                            </td>
                            <td style="padding:14px 16px; border:none; vertical-align:top;">
                                <strong style="color:var(--theme-main); font-size:14px;">{{ $item['class'] }}</strong>
                            </td>
                            <td style="padding:14px 16px; border:none; vertical-align:top;">
                                <ol style="margin:0; padding-left:18px; color:#555; font-size:13px; line-height:1.75;">
                            ...
                            <td style="padding:14px 16px; border:none; vertical-align:top; text-align:center;">
                                <span style="display:inline-block; min-width:34px; height:34px; line-height:34px;
            ...
            <div style="margin-top:20px; background:#fffbea; border:1px solid #ffe082; border-radius:8px; padding:14px 18px;">
                <p style="margin:0; font-size:13px; color:#666; line-height:1.75;">
                    ...
                    For Classes XI and XII, books vary by stream. Final subject-wise book details are shared by the respective stream coordinators.
                </p>
            </div>
        </div>
    </section>
