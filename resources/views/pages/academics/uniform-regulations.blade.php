        ...
        <div class="container">
            ...
            <div class="row" style="display:flex; flex-wrap:wrap; margin-top:10px;">
                <div class="col col-md-6 col-sm-6" style="margin-bottom:26px; display:flex;">
                    <div style="background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 3px 16px rgba(0,0,0,0.08); width:100%; display:flex; flex-direction:column;">
                        ...
                        <div style="padding:16px 18px; flex:1;">
                            ...
                            <div style="background:{{ $loop->odd ? '#f8fafd' : '#fff' }}; border:1px solid #e8edf5; border-radius:6px; padding:12px 14px; margin-bottom:10px;">
                                <strong style="display:block; color:var(--theme-main); font-size:13px; margin-bottom:4px;">{{ $season }}</strong>
                                <span style="font-size:14px; color:#555; line-height:1.65;">{{ $uniform }}</span>
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div style="background:#fffbea; border:1px solid #ffe082; border-radius:8px; padding:20px 22px;">
                        <div class="row">
                            <div class="col col-md-6" style="margin-bottom:10px;">
                                ...
                                <p style="margin:0; font-size:14px; color:#555; line-height:1.7;">{{ $data['pe_uniform'] }}</p>
                            </div>
                            <div class="col col-md-6" style="margin-bottom:10px;">
                                <h5 style="margin:0 0 8px; font-size:15px; font-weight:700; color:#6d4c41;">
                                ...
                                <p style="margin:0; font-size:14px; color:#555; line-height:1.7;">{{ $data['note'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
