    ...
    <section class="section-padding">
        <div class="container">
            ...
            <p style="font-size:15px; color:#555; max-width:780px; line-height:1.85; margin-bottom:40px;">
                ...
                All amounts are in Indian Rupees (&#8377;). Please read the terms &amp; conditions below the table
            ...
            <div class="row" style="margin-bottom:36px;">
                ...
                @foreach ($stats as $stat)
                    <div class="col col-md-3 col-sm-6" style="margin-bottom:16px;">
                        <div
                            style="background:#f4f7fb; border-radius:8px; padding:16px 18px;
                                display:flex; align-items:center; gap:14px;
                                border-left:4px solid var(--theme-main);">
                            <i class="fa {{ $stat['icon'] }}"
                                style="font-size:24px; color:var(--theme-main); flex-shrink:0;"></i>
                            <div>
                    ...
                    <tbody>
                        @foreach ($data as $i => $row)
                            ...
                            <tr
                                ...
                                <td
                                    style="padding:14px 20px; border:none; font-weight:700;
                                ...
                                <td style="padding:14px 20px; border:none; text-align:right;">
                                    <span
                                        style="background:#f0f4ff; border:1px solid #c5d3f5;
                    ...
                    <tfoot>
                        <tr style="background:#f4f7fb; border-top:2px solid #dde3ef;">
                            <td colspan="6"
                                ...
                                * Annual Total = (Monthly Tuition &times; 12) + Annual Charges. Admission fee is
                                one-time and not included in this total.
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            {{-- ── Terms & Conditions ── --}}
            <div
                style="margin-top:36px; background:#fff; border-radius:8px;
                        box-shadow:0 3px 16px rgba(0,0,0,0.07); overflow:hidden;">

                {{-- T&C header --}}
                <div
                    style="background:var(--theme-main); padding:14px 24px;
                    ...
                    @php
                        $terms = [
                            [
                                ...
                                'color' => '#3a5bbf',
                                'text' =>
                                    'Monthly tuition fee is due by the <strong>10th of every month</strong>. A late fine of &#8377;50/day is applicable after the due date.',
                            ],
                            [
                                'icon' => 'fa-refresh',
                                'color' => '#27ae60',
                                'text' =>
                                    'Fee once paid is <strong>non-refundable</strong> except in cases of school-initiated cancellation.',
                            ],
                            [
                                'icon' => 'fa-tags',
                                'color' => '#8e44ad',
                                'text' =>
                                    'A <strong>10% sibling discount</strong> on monthly tuition is applicable for the second child onwards enrolled in this school.',
                            ],
                            [
                                'icon' => 'fa-exclamation-circle',
                                'color' => '#c0392b',
                                'text' =>
                                    'Fees are subject to <strong>annual revision</strong>. Updated fee schedule will be notified at the start of each academic year.',
                            ],
                            [
                                'icon' => 'fa-bank',
                                'color' => '#2980b9',
                                'text' =>
                                    'Payments can be made by <strong>Cash, Demand Draft, or Online Transfer</strong>. Cheque payments are not accepted.',
                            ],
                            [
                                'icon' => 'fa-file-pdf-o',
                                'color' => '#e67e22',
                                'text' =>
                                    'A <strong>fee receipt must be collected</strong> for every payment. The school is not responsible for payments made without a receipt.',
                            ],
                            [
                                'icon' => 'fa-user-times',
                                'color' => '#c0392b',
                                'text' =>
                                    'Students with fee arrears of <strong>more than 2 months</strong> may be denied access to examinations until dues are cleared.',
                            ],
                            [
                                'icon' => 'fa-phone',
                                'color' => '#16a085',
                                'text' =>
                                    'For fee-related queries, contact the accounts office between <strong>9:00 AM – 1:00 PM</strong> on all working days.',
                            ],
                        ];
                    @endphp
                            ...
                            <div style="display:flex; align-items:flex-start; gap:12px; padding:0 14px;">
                                <div
                                    style="width:34px; height:34px; border-radius:50%; flex-shrink:0;
                                        ...
                                        margin-top:1px;">
                                    <i class="fa {{ $term['icon'] }}"
                                        style="color:{{ $term['color'] }}; font-size:15px;"></i>
                                </div>
                                <p style="margin:0; font-size:13px; color:#555; line-height:1.75;">
                                    <strong
                                        style="color:#999; font-size:11px; letter-spacing:.5px; display:block; margin-bottom:2px;">
                ...
                {{-- Disclaimer footer --}}
                <div
                    style="background:#fffbea; border-top:1px solid #ffe082;
                            padding:14px 24px; display:flex; align-items:flex-start; gap:12px;">
                    <i class="fa fa-exclamation-triangle"
                        style="color:#f9a825; font-size:18px; margin-top:2px; flex-shrink:0;"></i>
                    <p style="margin:0; font-size:13px; color:#666; line-height:1.7;">
                        <strong>Disclaimer:</strong> The fee structure displayed above is indicative and subject to
                        change without prior notice.
                        Kindly visit the school accounts office or call <strong>+91-11-XXXX-XXXX</strong> to confirm the
                        latest applicable fees before making any payment.
