    ...
    <section style="padding:50px 0;">
        <div class="container">
            ...
            <p style="font-size:15px; color:#555; max-width:820px; line-height:1.85; margin-bottom:34px;">
                We follow the <strong>CBSE curriculum</strong> designed to provide a balanced education across all
                levels � from early childhood to senior secondary. Each stage is thoughtfully structured to build
                conceptual clarity, critical thinking, and lifelong learning habits.
            </p>

            {{-- Curriculum table --}}
            <div class="table-responsive"
                style="border-radius:6px; overflow:hidden; box-shadow:0 2px 14px rgba(0,0,0,0.08);">
                <table class="table" style="margin:0; background:#fff; font-size:14px;">
                    <thead>
                        <tr style="background:var(--theme-main); color:#fff;">
                            ...
                            <th style="padding:14px 20px; font-size:14px; font-weight:700; border:none;">Subjects
                                Offered</th>
                            <th
                                style="padding:14px 20px; font-size:14px; font-weight:700; text-align:center; width:120px; border:none;">
                                Total Subjects</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($data as $i => $item)
                            <tr
                                style="background:{{ $i % 2 === 0 ? '#fff' : '#f8fafd' }}; border-bottom:1px solid #eef0f4;">
                                <td
                                    style="padding:16px 20px; font-weight:700; color:var(--theme-main); vertical-align:middle; white-space:nowrap; border:none;">
                                ...
                                <td style="padding:16px 20px; vertical-align:middle; border:none;">
                                    <div style="display:flex; flex-wrap:wrap; gap:7px;">
                                        @foreach ($item['subjects'] as $subject)
                                            <span
                                                style="display:inline-block; background:#f0f4ff;
                                ...
                                <td style="padding:16px 20px; text-align:center; vertical-align:middle; border:none;">
                                    <span
                                        style="display:inline-block; width:36px; height:36px; border-radius:50%;
                    ...
                    <tfoot>
                        <tr style="background:#f4f7fb; border-top:2px solid #e0e6ef;">
                            <td colspan="3" style="padding:12px 20px; font-size:13px; color:#777; border:none;">
                                ...
                                Board: <strong>CBSE</strong> &nbsp;|&nbsp; Assessment: <strong>CCE Framework</strong>
                                &nbsp;|&nbsp; Language of Instruction: <strong>English / Hindi</strong>
                            </td>
                        </tr>
                    </tfoot>
                </table>
        ...
        <div class="container">
            ...
            @foreach ($coCurricular['activities'] as $index => $activity)
                ...
                <div class="row" style="margin-bottom:0; align-items:stretch;">
                    ...
                    @if ($even)
                        <div class="col col-md-1 hidden-sm hidden-xs text-center" style="padding-top:38px;">
            ...
            <div
                style="margin-top:50px; background:var(--theme-main); border-radius:8px; padding:36px 40px; color:#fff;">
                <div class="row" style="align-items:center;">
                    <div class="col col-md-7">
                        ...
                        <ul style="margin:0; padding-left:20px; color:rgba(255,255,255,0.9);">
                            @foreach ($coCurricular['why_points'] as $point)
                                <li style="margin-bottom:10px; font-size:14px; line-height:1.7;">{{ $point }}
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="col col-md-5"
                        ...
                        <i class="fa fa-quote-left"
                            style="font-size:28px; color:rgba(255,255,255,0.4); display:block; margin-bottom:10px;"></i>
                        <p
                            style="font-size:15px; color:rgba(255,255,255,0.95); line-height:1.8; margin:0; font-style:italic;">
