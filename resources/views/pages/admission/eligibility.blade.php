<x-web-layout>
    ...
    <section style="padding:50px 0;">
        <div class="container">
                ...
                <table class="table" style="margin:0; background:#fff;">
                    ...
                    <tbody>
                        @foreach ($data as $index => $row)
                            <tr
                                style="background:{{ $index % 2 === 0 ? '#ffffff' : '#f8fafd' }}; border-bottom:1px solid #edf1f7;">
            ...
            <div
                style="margin-top:18px; background:#fffbea; border:1px solid #ffe082; border-radius:8px; padding:16px 18px;">
