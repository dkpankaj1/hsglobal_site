    ...
    <section style="padding:50px 0;">
        <div class="container">
            ...
            <div class="row" style="margin-bottom:24px;">
                ...
                <div class="col col-md-3 col-sm-6" style="margin-bottom:12px;">
                    <div
                        style="background:#fff5f5; border-left:4px solid #d9534f; border-radius:6px; padding:14px 16px;">
                ...
                <div class="col col-md-3 col-sm-6" style="margin-bottom:12px;">
                    <div
                        style="background:#f5fff7; border-left:4px solid #28a745; border-radius:6px; padding:14px 16px;">
                ...
                <div class="col col-md-3 col-sm-6" style="margin-bottom:12px;">
                    <div
                        style="background:#fef9f2; border-left:4px solid #f0ad4e; border-radius:6px; padding:14px 16px;">
            ...
            <div class="row" style="margin-top:6px; display:flex; flex-wrap:wrap;">
                    ...
                    <div
                        ...
                        <div style="padding:10px 12px;">
                            @foreach ($data as $index => $rule)
                                <div
                                    style="padding:12px 10px; border-bottom:{{ !$loop->last ? '1px solid #f0f3f8' : 'none' }}; display:flex; align-items:flex-start; gap:10px;">
                                    <span
                ...
                <div class="col col-md-4" style="margin-bottom:18px;">
                    <div
                        style="background:#ffffff; border:1px solid #e7edf7; border-radius:8px; padding:16px 16px 12px; margin-bottom:14px;">
                    ...
                    <div style="background:#fffbea; border:1px solid #ffe082; border-radius:8px; padding:14px 16px;">
                        <p style="margin:0; font-size:13px; color:#666; line-height:1.75;">
                            ...
                            For any fee dispute or payment confirmation issue, contact the accounts office with your
