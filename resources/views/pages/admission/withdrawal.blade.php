    ...
    <section style="padding:50px 0;">
        <div class="container">
            ...
            <p style="font-size:15px; color:#555; max-width:820px; line-height:1.85; margin-bottom:34px;">
                For student withdrawal or transfer, please follow the process below and ensure all academic and fee
                ...
                <div class="col col-md-8" style="margin-bottom:18px;">
                    <div
                        ...
                        <div style="position:relative; padding:14px 14px 10px 46px;">
                            <div
                                style="position:absolute; left:26px; top:24px; bottom:24px; width:2px; background:#dfe6f3;">
                            </div>
                            @foreach ($data as $index => $rule)
                                <div style="position:relative; padding:0 2px 12px 0;">
                                    <span
                                        style="position:absolute; left:-30px; top:4px; width:18px; height:18px; border-radius:50%; background:var(--theme-main); box-shadow:0 0 0 3px #eef3ff;"></span>
                                    <div
                                        style="background:#fff; border:1px solid #edf2fa; border-left:3px solid var(--theme-main); border-radius:6px; padding:10px 12px;">
                                        <strong
                                            style="display:block; font-size:12px; color:#7f8aa1; margin-bottom:3px;">STEP
                                            {{ str_pad($index + 1, 2, '0', STR_PAD_LEFT) }}</strong>
                                        <p style="margin:0; color:#555; font-size:14px; line-height:1.75;">
                                            {{ $rule }}</p>
                                    </div>
                                </div>
                            @endforeach
